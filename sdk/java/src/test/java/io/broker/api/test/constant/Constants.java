...
public class Constants {
    ...
    // FIXME: please change to your valid api domain for test, for example: coinegg.fun
    public static final String BASE_DOMAIN = "";

    // REST api url format: https://api.BASE_DOMAIN
    // for example: https://api.coinegg.fun
    ...
    // for example: wss://wsapi.coinegg.fun/openapi/quote/ws/v1
    ...
    // for example: wss://wsapi.coinegg.fun/openapi/ws
